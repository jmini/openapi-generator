...
public class JavaClientCodegenTest {
    ...
    public void arraysInRequestBody() throws Exception {
        ...
        CodegenParameter codegenParameter1 = codegen.fromRequestBody(body1 , new HashSet<String>(), null, null);
        ...
        CodegenParameter codegenParameter2 = codegen.fromRequestBody(body2 , new HashSet<String>(), null, null);
        ...
        openAPI.getComponents().addSchemas("Point", point);
